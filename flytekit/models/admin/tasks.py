...
from flytekit.models.core import compiler as _compiler
...
class TaskSpec(_common.FlyteIdlEntity):
    ...
    def from_flyte_idl(cls, pb2_object):
        ...
        :rtype: TaskSpec
        """
        return cls(_task.TaskTemplate.from_flyte_idl(pb2_object.template))
...
class TaskClosure(_common.FlyteIdlEntity):
    ...
    def from_flyte_idl(cls, pb2_object):
        ...
        :rtype: TaskClosure
        """
        return cls(compiled_task=_compiler.CompiledTask.from_flyte_idl(pb2_object.compiled_task))